    ...
    return (
        ...
        >
            <div className={styles.container}>
                ...
                <div className={styles.table}>
                    <table>
                        ...
                        <tr>
                            ...
                            <td>The cookie is used to send data to Google Analytics about your device and behaviour. It tracks you across de vices and marketing channels.</td>
                        </tr>
                        </tbody>
                    </table>
                </div>
                ...
                <p>The above-mentioned data will be sent to Google located in the United States. We have a legitimate interest in protecting the Site from abusive automated crawling and spam. For more information about Google reCAPTCHA and Google’s privacy policy, please visit the following links: https://www.google.com/intl/de/policies/privacy/ and https://www.google.com/recaptcha/intro/v3.html .</p>
                <h2><span>7.</span> CONTACT</h2>
                <p className={styles.subtitle}>If you have any questions about this cookie policy our our data protection practices, please contact us by using the following contact details:</p>
